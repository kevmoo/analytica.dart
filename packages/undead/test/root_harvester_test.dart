...
import 'package:undead/src/models.dart';
import 'package:undead/src/root_harvester.dart';
  ...
  group('RootHarvester & PackageTopology', () {
    test(
      ...
      () async {
        ...
        final options = UndeadOptions(packagePath: d.path('unresolved_pkg'));
...
'''),
    ...
    test('does not exclude lib/src/build/ source directory', () async {
      ...
      final options = UndeadOptions(packagePath: d.path('nested_build_pkg'));
      final harvester = RootHarvester(options);
      final topology = harvester.harvestTopology();
...
'''),
      ...
      final options = UndeadOptions(packagePath: d.path('multiline_build_pkg'));
